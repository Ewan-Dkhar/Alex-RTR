...
import { Check, X, ChevronDown, Database, Layout, Server, Sparkles, Zap, Smartphone, ArrowRight } from "lucide-react"
  ...
  return (
    <div className="bg-white pt-12 pb-24">
      ...
      <section className="max-w-5xl mx-auto px-4 py-24 mb-12">
        <SectionHeading title="Architecture & Engine" subtitle="A look behind the scenes at our elegant architecture and premium technology stack." />
        <Card variant="raised" className="p-8 md:p-12 relative overflow-hidden bg-skeuo-white mt-12">
